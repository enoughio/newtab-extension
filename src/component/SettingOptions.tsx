...
type SettingOptionsArgs = {
    onSelect : () => void;
    openDialogState : () => void
}


export const SettingOptions = ( {onSelect, openDialogState } : SettingOptionsArgs  )  => {
    ...
    return (
        <>
            <ul className="border rounded-lg py-3 px-2 ml-5 w-fit flex  flex-col gap-1" >
                ...
                <li className='flex row border rounded-lg p-1 text-xs ' >
                    <button onClick={ handleClick }  > <Plus size={16} className='inline-block text-[1px]'/>  Add new Shortcut </button>
                </li>
